...
using inventory_waved.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "inventory_waved", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<inventory_wavedContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "inventory_waved API v1");
